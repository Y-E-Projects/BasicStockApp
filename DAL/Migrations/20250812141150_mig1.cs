    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Key = table.Column<Guid>(type: "char(36)", nullable: false),
                    SellCode = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryKey = table.Column<Guid>(type: "char(36)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Key = table.Column<Guid>(type: "char(36)", nullable: false),
                    SellKey = table.Column<Guid>(type: "char(36)", nullable: false),
                    ProductKey = table.Column<Guid>(type: "char(36)", nullable: false),
